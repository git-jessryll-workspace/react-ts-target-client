...
const stats = [
    { name: "Overall total", value: '405' },
    { name: 'Total expenses', value: '3' },
    { name: 'Total income', value: '98.5%' },
    { name: "Number of transaction", value: '3.65', unit: 'mins' },
]
...
const GroupDetailsContent: React.FC<GroupDetailsContentProps> = () => {
    return (<AuthLayout>
        <header>
            ...
            {/* Heading */}
            <div className="flex flex-col items-start justify-between bg-gray-100 gap-x-8 gap-y-4 px-4 py-4 sm:flex-row sm:items-center sm:px-6 lg:px-8">
                <div>
                    <div className="flex items-center gap-x-3">
                        ...
                        <h1 className="flex gap-x-3 text-base leading-7">
                            <span className="font-semibold text-gray-700">Planetaria</span>
                            <span className="text-gray-600">/</span>
                            <span className="font-semibold text-gray-700">mobile-api</span>
                        </h1>
                    </div>
                ...
                {stats.map((stat, statIdx) => (
                    ...
                    >
                        ...
                        <p className="mt-2 flex items-baseline gap-x-2">
                            <span className="text-4xl font-semibold tracking-tight text-gray-500">{stat.value}</span>
        ...
        <div className="border-t border-white/10 pt-6">
            <h2 className="px-4 text-base font-semibold leading-7 text-gray-700 sm:px-6 lg:px-8">Latest activity</h2>
                        ...
                        <tr key={item.commit}>
                            <td className="py-4 pl-4 pr-8 sm:pl-6 lg:pl-8">
                                <div className="flex items-center gap-x-4">
                                    ...
                                    <div className="truncate text-sm font-medium leading-6 text-gray-700">{item.user.name}</div>
                                </div>
                            </td>
                            ...
                            <td className="py-4 pl-0 pr-4 text-sm leading-6 sm:pr-8 lg:pr-20">
                                <div className="flex items-center justify-end gap-x-2 sm:justify-start">
                                    ...
                                    <div className="hidden text-gray-700 sm:block">{item.status}</div>
                                </div>
                            </td>
