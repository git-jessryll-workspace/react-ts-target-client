    ...
    return <li key={transaction._id} className="relative flex justify-between gap-x-6 py-5 px-6">
        <div className="flex min-w-0 gap-x-4">
            <div className="min-w-0 flex-auto">
                <p className="text-sm font-semibold leading-6 text-gray-900 flex space-x-3">
        ...
        <div className="flex shrink-0 items-center gap-x-4">
            <div className="flex flex-col items-end">
                ...
                <p className="text-xs text-gray-500">{new Date(transaction.transaction_date).toLocaleString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                })}</p>
